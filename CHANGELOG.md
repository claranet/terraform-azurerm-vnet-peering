...
release. Two provider-level behaviour changes shipped with AzureRM 5.0 also apply:
`resource_provider_registrations` now defaults to `none` instead of `legacy`, so no
resource provider is registered automatically anymore, and the `enhanced_validation`
block moved inside `features` with location and resource provider validation now
disabled by default, which defers those errors from plan time to apply time.

### Features

* **SREAA-368:** upgrade module to v9 (OpenTofu >= 1.12, AzureRM ~> 5.0) 6c2d02b

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.5 63be8c2
* **deps:** update dependency tflint to v0.64.0 9a92af6
* **SREAA-368:** synchronize committed.toml and AGENTS.md from the ci template d448601
* **v9:** 🐛 synchronize common files and docs a6a33be

## 8.1.5 (2026-07-20)

### Bug Fixes

* **tflint:** 🐛 bump Azure rules version, fix signature bug 30d5629

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 14f6a9c
* **deps:** update dependency opentofu to v1.12.2 f0df0ec
* **deps:** update dependency opentofu to v1.12.3 f0aa36c
* **deps:** update dependency opentofu to v1.12.4 c13f205
* **deps:** update dependency tflint to v0.63.1 0463367
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 a301f23
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 8114e4a

## 8.1.4 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 2c3e07a

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu c708ae9
* **deps:** update dependency opentofu to v1.12.0 f114ad2
* **deps:** update dependency terraform-docs to v0.23.0 3444500
* **deps:** update dependency terraform-docs to v0.24.0 1684401
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 c3f4782
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 e37e5d6
* **deps:** update tools e29b1df
* **pre-commit:** 🔧 move to prek 769767c
* **tfdocs:** bump tfdocs to v0.22 🔧 3d78cc1

## 8.1.3 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ e96455a

### Code Refactoring

* update module structure and Github actions 👷 f2a339b

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing cde670b
* **deps:** 🔗 bump tflint rules version 0842e96
* **deps:** update dependency trivy to v0.69.2 d22e909
* **deps:** update dependency trivy to v0.69.3 29317f2
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 0f468bc

## 8.1.2 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 0cab159

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.7 a924f14
* **deps:** update dependency opentofu to v1.11.1 6471b6b
* **deps:** update dependency opentofu to v1.11.2 6683c3d
* **deps:** update dependency opentofu to v1.11.3 c0e88b2
* **deps:** update dependency opentofu to v1.11.4 2c7cf44
* **deps:** update dependency opentofu to v1.11.5 cc733a8
* **deps:** update dependency pre-commit to v4.4.0 e57c4d4
* **deps:** update dependency pre-commit to v4.5.0 e086809
* **deps:** update dependency pre-commit to v4.5.1 d310666
* **deps:** update dependency terraform-docs to v0.21.0 4a38946
* **deps:** update dependency tflint to v0.60.0 7a1540d
* **deps:** update dependency tflint to v0.61.0 8834e8c
* **deps:** update dependency trivy to v0.67.1 96b8a83
* **deps:** update dependency trivy to v0.67.2 e5d02e1
* **deps:** update dependency trivy to v0.68.1 6e58f72
* **deps:** update dependency trivy to v0.68.2 699e9a2
* **deps:** update dependency trivy to v0.69.0 5fd8fe5
* **deps:** update dependency trivy to v0.69.1 8730193
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 4d11131
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 ef0e7dc
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 4757f76
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.2 3b15d66

## 8.1.1 (2025-10-01)

### Code Refactoring

* **deps:** 🔗 update claranet/azurecaf to ~> 1.3.0 🔧 70e812c

### Miscellaneous Chores

* **deps:** 🔗 bump AzureRM provider version to v4.31+ a9355e1
* **deps:** update dependency opentofu to v1.10.6 71d9b67
* **deps:** update dependency tflint to v0.59.1 d7db2fb
* **deps:** update dependency trivy to v0.66.0 af33b6a
* **deps:** update dependency trivy to v0.67.0 6c04ff4
* **deps:** update pre-commit hook pre-commit/pre-commit-hooks to v6 5c27978
* **deps:** update tools e1463e1
